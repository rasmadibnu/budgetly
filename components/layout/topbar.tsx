...
import { ChevronLeft, ChevronRight, LogOut, Moon, Sun, WifiOff } from "lucide-react";
...
export function Topbar({ email }: { email: string }) {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between border-b px-6 lg:px-8">
      <div className="flex items-center gap-1.5">
        ...
        <Select value={month} onValueChange={onMonthChange}>
          <SelectTrigger className="h-8 w-[160px] border-0 bg-transparent px-2 text-[13px] font-semibold shadow-none focus:ring-0">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
